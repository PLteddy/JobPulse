 ...
 */
final class Version20250413180316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE formation formation VARCHAR(500) DEFAULT NULL, CHANGE decription decription VARCHAR(500) DEFAULT NULL, CHANGE experience experience VARCHAR(500) DEFAULT NULL, CHANGE plus_sur_moi plus_sur_moi VARCHAR(500) DEFAULT NULL');
    }
